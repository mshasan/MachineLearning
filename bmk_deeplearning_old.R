...
model_loaded_AE <- h2o.loadModel("best_model_AE\\dl_grid_random_bmk_AE_model_92")
# summary(model_loaded_AE)
#predict(model_loaded_AE, as.h2o(train))
h2o.auc(model_loaded_AE, train=TRUE, valid=TRUE, xval=TRUE)

#h2o.cross_validation_models(model_loaded_AE)
...
# nfolds <- model_loaded_AE@parameters$nfolds
# predlist <- sapply(1:nfolds, function(v) h2o.getFrame(model_loaded_AE@model$cross_validation_predictions[[v]]$name)$predict, simplify = FALSE)
...
mplot_density(tag = tag_AE, 
                   ...
                   save = TRUE, 
                   file_name = "AE_dl_distribution.png")
...
mplot_density(tag = tag_CIE, 
              ...
              save = TRUE, 
              file_name = "CIE_dl_distribution.png")
...
mplot_density(tag = tag_SSCIE, 
              ...
              save = TRUE, 
              file_name = "SSCIE_dl_distribution.png")
